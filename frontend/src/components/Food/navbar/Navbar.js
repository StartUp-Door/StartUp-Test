        ...
        <div key={noti.id} style={{paddingRight: 5}}>
          <MenuItem onClick={handleMenuClose1}> 
            ...
            <div>
              ...
              {/* <div style={{display: 'block', alignItems: 'center', textAlign:'center', borderRadius: 10, boxShadow: '0 0 16 -8 rgba(0, 0, 0, 0.88);', borderColor: 'red', border: 5}}> 
                <div>               
                <img 
                  style={{width: 40, height: '100%', borderRadius: '20%'}} 
                  src={noti.cimage ? ("http://localhost:4000/images/" + noti.cimage) : "http://localhost:4000/images/noprofile.png"} 
                /> 
                <span>{noti.cname} <br/>
                {noti.caddress} <br/>
                {noti.cno}</span>
              ...
              {/* <div style={{padding: 10}}>
                <span style={{fontWeight: 'bold'}}>Posted Job Detail : <br/> </span>
                {noti.description}<br/> 
                <img style={{width: 200, height: '100%', borderRadius: '5%'}} src={noti.image ? "http://localhost:4000/images/" + noti.image : 'test'} alt="" />  
              </div>  */}
      ...
      <AppBar position="static" style={{backgroundColor:"#1A2A4A"}}>
        <Toolbar>
          ...
          <div className={classes.search}>
            ...
            <InputBase
              placeholder="Search for a Food & Cuisine job here…"
              classes={{
